...
file.db.current    = "databases/db_traits_tachet_AP.dat"
file.db.temp       = "databases/db_traits_tachet_AP.dat"  # AP
file.db.sapro      = "databases/db_freshwaterecology_20131206_AP.dat"
#file.db.pH        = "databases/db_freshwaterecology_20131206.dat"
file.db.spear      = "databases/db_traits_rspear_Eurasia_20130114_AP.dat"
...
par <- sysanal.read.distdef("input/parameter_input_Reform.dat")
